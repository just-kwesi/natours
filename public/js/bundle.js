...
var displayMap = function displayMap(tourLocation) {
  mapboxgl.accessToken = 'pk.eyJ1IjoianVzdC1rd2VzaSIsImEiOiJjbGZrMzR6c3UwNWhnM3N0YTJyN25rdHJ3In0.wtA2dCSx4oQBWrlWdPrzpw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/just-kwesi/clfk45v2q00b401nxvxgjjna4',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "User ".concat(type, " changed successfully!"));
            window.setTimeout(function () {
              location.assign('/me');
            }, 1000);
          }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MsXKCDxuU00IA8fBCbt1KHY4wA1mKbii1Qt8ShVi3aiivhFsj8I9YiumlaB7iOVzcd7k5nbtdnTKgh451VhmdGU008mHfLany');
